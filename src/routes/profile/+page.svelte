<div class="p-16">
    ...
    <div class="mt-20 text-center border-b pb-12">
        <h1 class="text-4xl font-medium text-gray-700">Test User,  <span class="font-light text-gray-500">27</span></h1>
        <p class="font-light text-gray-600 mt-3">Joined on:💀</p>
      </div>
     
     <div class="mt-12 flex flex-col justify-center">
        <p class="text-gray-600 text-center font-light lg:px-16">Толкова дърт не е писал никой освен Кристиян Петров Георгиев 4ти,помощ котката ми стъпва на клавиетурата и след малко ще хвърля</p>
